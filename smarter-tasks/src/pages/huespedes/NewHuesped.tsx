// src/pages/projects/NewHuesped.tsx
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      />
                      {errors.name && <span>Nombre del huésped es requerido</span>}
                      <select
                      ...
                      {errors.tipo && <span>Tipo de huésped es requerido</span>}
                      <input
                        type="text"
                      ...
                      />
                      {errors.identificacion && <span>Identificación del huésped es requerido</span>}
                      <input
                        type="email"
                        placeholder="Email del huésped"
                        autoFocus
                        {...register("email", { required: true, setValueAs: (v) => v.trim(),
                          pattern: {
                            value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
                      ...
                      />
                      {errors.email && <span>Email del huésped es requerido</span>}
                      <input
                        type="text"
                        placeholder="Teléfono del huésped"
                        autoFocus
                        {...register("telefono", { required: true, setValueAs: (v) => v.trim(), })}
                        className={`w-full border rounded-md py-2 px-3 my-4 text-gray-700 leading-tight focus:outline-none focus:border-blue-500 focus:shadow-outline-blue ${
                          errors.telefono ? "border-red-500" : ""
                        }`}
                      />
                      {errors.telefono && <span>Teléfono del huésped es requerido</span>}
                      <button
                        id="submitNewHuespedBtn"
                        type="submit"
